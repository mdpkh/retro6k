...
0300-037F & --- & Sound output  (see section \ref{sec:soundoutput}, page \pageref{sec:soundoutput}) \\
0380-03BF & --- & Peripheral device output  (see section \ref{sec:devoutput}, page \pageref{sec:devoutput}) \\
...
\begin{center}\begin{tabular}{>{\ttfamily}c>{\ttfamily}cl}
...
\begin{center}\begin{tabular}{>{\ttfamily}c>{\ttfamily}c>{\ttfamily}c}
